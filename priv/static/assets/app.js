...
`, template.innerHTML.trim());
  ...
  var linkcontentList = document.getElementsByClassName("linkcontentList");
    ...
    mounted() {
      ...
      window.addEventListener("scroll", () => {
        ...
        if (document.getElementById("sectionsevenTop").getBoundingClientRect().top > 0) {
          ...
          if (screenHeight > 956) {
            ...
            sevenList = "-640px";
            document.getElementById("sevenList").removeAttribute("style");
            if (document.getElementById("sectionsevenTop").getBoundingClientRect().top < 465) {
              console.log("AAA");
              document.getElementById("sixList").style.position = "fixed";
              document.getElementById("sixList").style.top = sixListTop;
            } else {
      ...
      function genderinput(b) {
        ...
        for (let i2 = 0; i2 < 3; i2++) {
          gender[i2].classList.remove("checked-value");
        }
      ...
      function sidebarSlide2() {
      }
    }
  };
  Hooks2.SectionTopOnly = {
    mounted() {
  ...
  Hooks2.SectionTopChangeContent = {
    mounted() {
  ...
  Hooks2.ToggleServiceIphoneMenu = {
    mounted() {
